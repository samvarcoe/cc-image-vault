...
const COLLECTION_NAME = 'ViewingImagesCollection';
const EMPTY_COLLECTION_NAME = 'ViewingImagesEmptyCollection';
const ERROR_COLLECTION_NAME = 'ViewingImagesErrorCollection';
...
test.describe('Client - Collection Page - Viewing Images', () => {
    ...
    test('User views the Collection page with no Status set', async ({ page }) => {
        ...
        // Then the user is redirected to "/collection/[COLLECTION_NAME]?status=COLLECTION"
    ...
    test('User views Collection images on the Collection page', async ({ page }) => {
        ...
        // When the user visits the Collection page "/collection/[COLLECTION_NAME]?status=COLLECTION"
    ...
    test('User views INBOX images on the Collection page', async ({ page }) => {
        ...
        // When the user visits the Collection page "/collection/[COLLECTION_NAME]?status=INBOX"
    ...
    test('User views ARCHIVE images on the Collection page', async ({ page }) => {
        ...
        // When the user visits the Collection page "/collection/[COLLECTION_NAME]?status=ARCHIVE"
    ...
    test('User views Collection with no images for a specific Status', async ({ page }) => {
        ...
        await ui.collectionPage.visit(EMPTY_COLLECTION_NAME, testStatus);
    ...
    test('Error occurs when retrieving Collection images', async ({ page }) => {
        ...
        // Given a Collection exists with name "[COLLECTION_NAME]"
        const collection = Collection.create(ERROR_COLLECTION_NAME);
