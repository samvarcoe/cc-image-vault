...
export class AssertableError {
  ...
  shouldHaveType<T extends Error>(errorType: ErrorConstructor<T>): AssertableError {
    ...
    LOGGER.log('✓ The Error was thrown with the expected instance type');
    return this;
  }
  ...
  shouldHaveMessage(message: string): AssertableError {
    ...
    LOGGER.log('✓ The Error was thrown with the expected message')
    return this;
  }
  ...
  shouldHaveCause<T extends Error>(causeType: ErrorConstructor<T>): AssertableError {
    ...
    LOGGER.log('✓ The Error cause was thrown with the expected instance type')
    return this;
  }
  ...
  shouldHaveCauseMessage(message: string): AssertableError {
    ...
    LOGGER.log('✓ The Error cause was thrown with the expected message');
    return this;
  }
}
